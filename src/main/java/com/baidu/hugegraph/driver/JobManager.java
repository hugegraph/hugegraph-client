...
import static com.baidu.hugegraph.driver.SchemaManager.ASYNC_TIMEOUT;
...
public class JobManager {
    ...
    public void rebuild(VertexLabel vertexLabel) {
        this.rebuild(vertexLabel, ASYNC_TIMEOUT);
    }
    ...
    public void rebuild(EdgeLabel edgeLabel) {
        this.rebuild(edgeLabel, ASYNC_TIMEOUT);
    }
    ...
    public void rebuild(IndexLabel indexLabel) {
        this.rebuild(indexLabel, ASYNC_TIMEOUT);
    }
